...
namespace CarlosM_ExamenP1.Controllers
{
    public class MascotasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Raza,Edad,Peso,Sexo")] Mascota mascota)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Raza,Edad,Peso,Sexo")] Mascota mascota)
        {
            if (id != mascota.Id)
            {
                return NotFound();
